...
async function connectToWA() {
  ...
  console.log("Connecting 😈WSpyder😈");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("😈WSpyder😈 installed successful ✅");
      console.log("😈WSpyder😈 connected to whatsapp ✅");

      let up = `😈WSpyder😈 connected successful ✅`;
      let up1 = `Hello 😈WSpyder😈, I made bot successful`;
      ...
      robin.sendMessage("94724610079@s.whatsapp.net", {
        image: {
